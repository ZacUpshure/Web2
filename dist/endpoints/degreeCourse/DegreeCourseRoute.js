...
import { getAllDegreeCourses, getDegreeCourse, createDegreeCourse, updateDegreeCourse, deleteDegreeCourse } from './DegreeCourseService.js';
// erstellt Router
...
degreeCourseRouter.get('/:courseID', async (req, res) => {
    try {
        // parameter fischen
...
degreeCourseRouter.get('/:id/degreeCourseApplications', requireAuth, requireAdmin, async (req, res) => {
    try {
