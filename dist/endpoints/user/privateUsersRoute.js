...
import { findAllUsersService, findUserByIdService, updateUserService, deleteUserService } from './UserService.js';
...
privateUserRouter.get('/:userID', requireSelfOrAdmin, async (req, res) => {
    const userID = req.params.userID; // ← string bleibt string
